...
def tokenizing(str_):
    ...
    for i in range(len(str_+" ")-1):
        ...
        for j in range(1):
            ...
            # evaluasi angka
            elif current_token.isdigit() and num_zone == False and str_zone == False and opr_zone == False and opl_zone == False and opa_zone == False and ident_zone == False:
                temp_num+=current_token
                current_token = ""
                num_zone = True

            elif current_token.isdigit() and num_zone == True and str_zone == False and opr_zone == False and opl_zone == False and opa_zone == False and ident_zone == False:
                temp_num+=current_token
                current_token = ""


            elif not current_token.isdigit() and num_zone == True and str_zone == False and opr_zone == False and opl_zone == False and opa_zone == False and ident_zone == False:
                token.append(("NUM", temp_num))
                temp_num = ""
                num_zone = False
